    ...
    return(
        <div className='divNav'>
            ...
            <nav className="navFlex">
                <ul className='lista'>
                    <li><a href='#' className='Item'>Buzos</a></li>
                    <li className='drop'><a href='#' className='Item'>Remeras</a>
                        <ul className='dropdawn'>
                            <li><a href='#' className='Item'>Remeras Lisas</a></li>
                            <li><a href='#' className='Item'>Remeras Estampadas </a></li>
                        </ul>
                    </li>
                    <li> <a href='#' className='Item'>Bermudas</a></li>
                    <li> <a href='#' className='Item'>Conjuntos</a></li>
